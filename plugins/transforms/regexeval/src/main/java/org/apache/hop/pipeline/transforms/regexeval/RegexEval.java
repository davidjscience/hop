 ...
 * @since 15-08-2007
 */
public class RegexEval extends BaseTransform<org.pentaho.di.trans.steps.regexeval.RegexEvalMeta, org.pentaho.di.trans.steps.regexeval.RegexEvalData> implements StepInterface {
  private static Class<?> PKG = org.pentaho.di.trans.steps.regexeval.RegexEvalMeta.class; // for i18n purposes,
  // needed by
  // Translator2!!



  public RegexEval( TransformMeta transformMeta, RegexEvalMeta meta, RegexEvalData  data, int copyNr,
